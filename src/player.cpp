...
void CBasePlayer::SetForScreenshot(int dir) {
	pev->origin.x = pev->origin.y = pev->origin.z = 0;
	pev->view_ofs = Vector (0, 0, 0);
	switch(dir) {
	case 0: // forward
		StartObserver( Vector(0,0,0), UTIL_VecToAngles( Vector(0,1,0) ) );
		break;
	case 1: // right
		StartObserver( Vector(0,0,0), UTIL_VecToAngles( Vector(1,0,0) ) );
		break;
	case 2: // back
		StartObserver( Vector(0,0,0), UTIL_VecToAngles( Vector(0,-1,0) ) );
		break;
	case 3: // left
		...
		break;
	case 4: // up
		StartObserver( Vector(0,0,0), UTIL_VecToAngles( Vector(0,0,1) ) );
		break;
	case 5: // down
		StartObserver( Vector(0,0,0), UTIL_VecToAngles( Vector(0,0,-1) ) );
		break;
